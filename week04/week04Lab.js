...
//Answer: 
console.log('Why use const? Using const prevents the value of the variable from being changed. ');
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`${myName} and ${friendName} are having ${food} and ${drink} for lunch.`);
...
//Answer: 
console.log("USING CONCATENATION: " + myName + " and " + friendName + " are having " + food + " and " + drink + " for lunch.");
console.log(`-------------------------- 
Question 2a: Oh no`)
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
// drink = "Beer"; (does not work)
console.log(drink);

//Question: Read the error message - in your own words - what does it mean?
//Answer:
console.log('Uncaught TypeError: invalid assignment means you cannot reassign a value to a const variable.' );
...
const lunchTime = (foodChoice, drinkChoice) => `${myName} and ${friendName} are having ${foodChoice} and ${drinkChoice} for lunch.`;
console.log(lunchTime('Pizza','Water'))
...
//    return `${myName} and ${friendName} are having ${foodChoice} and ${drinkChoice} for lunch.`;
// }
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
const foorForTodayAndTomorrow = (tomorrowsFoodChoice, tomorrowsDrinkChoice, callbackFunction) => {
   return `${callbackFunction} Tomorrow they want ${tomorrowsFoodChoice} and ${tomorrowsDrinkChoice}`;

}
console.log(foorForTodayAndTomorrow('Tacos', 'Corona', lunchTime('Pizza', 'Soda')));
