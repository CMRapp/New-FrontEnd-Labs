 ...
 * Step 1: Print to the console the following sentence (make sure to fill in the name, and year programmatically): 
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
 let myGreeting = new Greeting('Christian', 'FL');
 myGreeting.hello();
/*-------------------------------------------------------*/
// Question 3: myBook
console.log(`--------------------------
 ...
 * ↓ YOUR CODE HERE ↓ */
 ...
 let yourBook = new Book('Alex Cross', 'James Patterson');
 ...
 * ↓ YOUR CODE HERE ↓ */
 class Fruit {
  ...
  description () {
    return `A ${this.name} is ${this.color} and tastes ${this.taste}.`
  }  
 }
 ...
 *  (make sure to fill in the title and director programmatically): 
 ...
 * Step 4: Create a method called addMovie inside of List that will recieve a movie as a parameter and 
 ...
 * Step 6: Create two instances of Movie called movie1, use "Jurassic Park" and "Steven Spielberg" as it's arguments 
 * AND movie2, use "How the Grinch stole Christmas" and "Ron Howard" as it's arguments
